...
var PostsService = /** @class */ (function () {
    ...
    PostsService.prototype.getAllPost = function () {
        return this.http.get('http://127.0.0.1:8000/api/posts');
    };
    PostsService.prototype.addNewpost = function (post) {
        console.log(post);
...
var PostsComponent = /** @class */ (function () {
    function PostsComponent(post, http) {
        this.post = post;
        this.http = http;
    ...
    PostsComponent.prototype.getDatas = function () {
        var _this = this;
        this.post.getAllPost().subscribe(function (data) {
            console.log(data);
...
module.exports = __webpack_require__(/*! /var/www/html/angluer6/src/main.ts */"./src/main.ts");
